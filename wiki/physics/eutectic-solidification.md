---
title: "Eutectic solidification"
category: physics
tags: [eutectic, lamellar, rod, peritectic, microgravity]
papers:
...
In a eutectic reaction L → α + β both solids grow cooperatively behind
a common front. Classical **Jackson–Hunt** theory gives
λ² · V = const and sets the spacing λ that minimises front undercooling.
In µg the **lamellar↔rod** transition and spiral eutectic patterns can
be observed without buoyant perturbations.
...
- [[../Spiral eutectic growth dynamics facilitated by space Marangoni convection and liquid surface wave_HAIPENG.pdf|Haipeng — spiral eutectic via Marangoni]] — [[wiki/flow/marangoni-flow|marangoni flow]]-driven spiral
  eutectic.
- [[../Outer space cultivated regular eutectic cells with anomalous internal microstructures for rapidly solidifying Zr50V50 hypereutectic alloy_HAIPENG.pdf|Haipeng — Zr50V50 hypereutectic in space]] — anomalous rapidly-solidified Zr-V.
- [[../Observations of the occurrence and disappearance of peritectic couple growth performed under microgravity conditions_ANDREAS.pdf|Ludwig — peritectic couple growth µg]] — [[wiki/alloys/Pb-Sn|Pb-Bi]]-like peritectic
  couple growth, appearance/disappearance in µg.
...
- [[wiki/alloys/Al-Si|Al Si]] · [[wiki/alloys/SCN-transparent-analog|SCN transparent analog]] · [[wiki/alloys/Sn-based|Sn based]] · [[wiki/alloys/Sn-Bi-Sn-Pb|Sn Bi Sn Pb]] · [[wiki/alloys/Pb-Sn|Pb Sn]]
...
- [[wiki/flow/marangoni-flow|marangoni flow]] · [[wiki/flow/thermosolutal-convection|thermosolutal convection]]
- [[wiki/platforms/DECLIC-DSI|DECLIC DSI]] · [[wiki/platforms/ISS-experiments|ISS experiments]] · [[wiki/platforms/containerless-EML|containerless EML]]
...
| [[../In-situ composite microstructure formation of immiscible alloy solidified in space_JIUZHOU.pdf|Jiuzhou — immiscible alloy in space]] | In-situ composite from immiscible alloy in space |
